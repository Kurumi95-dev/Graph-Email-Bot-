...
# Tạo nội dung file đính kèm
timestamp = datetime.now().strftime("%I:%M%p %d-%m-%Y")
content = (
    "Quỳnh Minh Thần Nữ Lục (Không Xanh Biếc Sửa Chữa Bản 1-91)\n"
    "Chào bạn, đây là tệp Quỳnh Minh Thần Nữ Lục được gửi từ Graph API.\n"
    + timestamp
)
        ...
        "attachments": [
            {
                ...
                "name": "Quỳnh Minh Thần Nữ Lục.txt",
